...
public class registroinventario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtnumerodemaquina = new javax.swing.JTextField();
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            ...
                            .addComponent(txtnumerodemaquina))
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                            .addComponent(jLabel1)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                            .addComponent(txtnumerodeserie, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txtnumerodemaquina, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel7)
...
// TODO add your handling code here:
    ...
    public void filtrardatos(String valor) {
        ...
        String titulos[]={"N° Serie","N° Maquina","Modelo"};
        String[]registros=new String[3];
        
        DefaultTableModel modelo=new DefaultTableModel(null, titulos);
        
        String SQL="select * from inventario where n_maquina like '%"+valor+"%'";
        ...
        try {
            ...
            while (rs.next()){
                registros[0]=rs.getString("n_serie");
                registros[1]=rs.getString("n_maquina");
...
// TODO add your handling code here:
    ...
    private void tablainventarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablainventarioMouseClicked
        ...
        txtnumerodeserie.setText(tablainventario.getValueAt(filaseleccionada, 1).toString());
        txtnumerodemaquina.setText(tablainventario.getValueAt(filaseleccionada, 0).toString());
...
// TODO add your handling code here:
    ...
    public void eliminaregistro(){
        ...
        try {
            String SQL = "Delete from inventario where n_serie=" +tablainventario.getValueAt(filaseleccionada, 0);
            Statement st =con.createStatement();
    ...
    public void insertardatos(){
        try {
            ...
            pst.setString(2, txtnumerodeserie.getText());
            pst.setString(1, txtnumerodemaquina.getText());
        ...
        try {
            String SQL="update inventario set n_serie=?, n_maquina=?, modelo=? where n_maquina=?";
    ...
    private javax.swing.JTextField txtnumerodemaquina;
